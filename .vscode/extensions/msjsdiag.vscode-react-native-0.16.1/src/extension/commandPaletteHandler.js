...
exports.CommandPaletteHandler = void 0;
...
class CommandPaletteHandler {
    static addFolder(workspaceFolder, stuff) {
        ...
        this.projectsCache[workspaceFolder.uri.fsPath] = Object.assign(Object.assign({}, stuff), { workspaceFolder });
    }
    ...
    static startPackager() {
        return this.selectProject()
            .then((project) => {
            return projectVersionHelper_1.ProjectVersionHelper.getReactNativePackageVersionsFromNodeModules(project.packager.getProjectPath())
                .then(versions => {

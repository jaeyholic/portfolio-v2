...
class SettingsHelper {
     ...
     */
    static getReactNativeGlobalCommandName(uri) {
        const workspaceConfiguration = vscode.workspace.getConfiguration("react-native-tools", uri);
        if (workspaceConfiguration.has("reactNativeGlobalCommandName")) {
            return configurationReader_1.ConfigurationReader.readString(workspaceConfiguration.get("reactNativeGlobalCommandName"));
        }
        return null;
    }
    /**
